        ...
        <div className="mx-5 mt-7 lg:flex lg:mt-30 gap-4">
            <div id="visi">
                ...
                <div className="shadow-md shadow-white p-4 mb-4 lg:mb-0 lg:p-8 rounded">
                    <p className={`${Font.className} text-white text-center`}>Menjadi pionir brand clothing yang membahas tentang film dan musisi</p>
                </div>
            </div>
            <div>
                <h1 className="text-transform: uppercase font-bold text-2xl text-center" id="tentang_kami">Misi</h1>
                <hr class="h-px mt-4 lg:my-8 bg-gray-200 border-0 dark:bg-gray-700" />
                <div id="misi" className="lg:flex gap-4">
                    <div className='mt-4 lg:mt-0'>
                        <div className="shadow-md shadow-white p-4 lg:p-8 rounded">
                            <p className="text-white text-center">Menjadi pionir brand clothing yang membahas tentang film dan musisi</p>
                        </div>
                    </div>
                    <div className='mt-4 lg:mt-0'>
                        <div className="shadow-md shadow-white p-4 lg:p-8 rounded">
